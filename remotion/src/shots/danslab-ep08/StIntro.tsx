...
// Ep08 0 — title. No VO. "DANSLAB · NO. 08 / The Studio".
export const compositionConfig = { id: 'StIntro', durationInSeconds: 12, fps: 30, width: 1920, height: 1080 };
  ...
  return (
    <AbsoluteFill style={{ fontFamily: DL_SANS, opacity: fadeOut }}>
      ...
      <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center', opacity: nameOp, transform: `scale(${nameScale})` }}>
        <div style={{ opacity: numOp, fontFamily: DL_MONO, fontSize: 27, letterSpacing: 10, color: DL.red }}>DANSLAB · NO. 08</div>
        <div style={{ fontFamily: DL_SERIF, fontWeight: 500, fontSize: 148, color: DL.text, marginTop: 20 }}>
          The <span style={{ fontStyle: 'italic', color: DL.gold }}>Studio</span>
        </div>
        ...
        <div style={{ opacity: tagOp, fontFamily: DL_SERIF, fontStyle: 'italic', fontSize: 40, color: DL.warm, marginTop: 30 }}>
          The cloud does the work. One desk holds the truth.
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
