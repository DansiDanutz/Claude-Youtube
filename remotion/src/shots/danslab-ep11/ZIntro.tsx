...
export const compositionConfig = { id: 'ZIntro', durationInSeconds: 13, fps: 30, width: 1920, height: 1080 };

const TITLE = 140;

const ZIntro: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ fontFamily: DL_SANS, opacity: fadeOut }}>
      ...
      <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center', opacity: nameOp, transform: `scale(${nameScale})` }}>
        <div style={{ opacity: numOp, fontFamily: DL_MONO, fontSize: 27, letterSpacing: 10, color: DL.red }}>DANSLAB · NO. 11</div>
        ...
        <div style={{ opacity: tagOp, fontFamily: DL_SERIF, fontStyle: 'italic', fontSize: 40, color: DL.warm, marginTop: 30 }}>
          Five products. One wheel. The secret of the revenue.
        </div>
