...
// Series logo intro (no VO) — mirrors the DansLab classic-intro pacing.
export const compositionConfig = { id: 'NxIntro', durationInSeconds: 11, fps: 30, width: 1920, height: 1080 };

const NxIntro: React.FC = () => {
  ...
  const ruleW = interpolate(f, [120, 160], [0, 760], { ...NCLAMP, easing: NX_EASE.out });
  return (
    <AbsoluteFill style={{ fontFamily: NX_SANS }}>
      <NxBackdrop />
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        {/* The real product mark, drawing itself axon by axon then firing. */}
        <div style={{
        ...
        <div style={{ opacity: ap(84), fontFamily: NX_SERIF, fontSize: 104, color: NX.text, marginTop: 26, letterSpacing: -1 }}>
          Enroll Your Agent
        </div>
        ...
        <div style={{ opacity: ap(190), fontFamily: NX_SANS, fontSize: 33, color: NX.dim, marginTop: 34 }}>
          Five minutes. No cost. You keep your keys.
        </div>
