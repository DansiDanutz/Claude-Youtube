...
// Ep04 0 — title. No VO. "DANSLAB · NO. 04 / The Overseer".
export const compositionConfig = { id: 'OIntro', durationInSeconds: 12, fps: 30, width: 1920, height: 1080 };
  ...
  return (
    <AbsoluteFill style={{ fontFamily: DL_SANS, opacity: fadeOut }}>
      ...
      <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center', opacity: nameOp, transform: `scale(${nameScale})` }}>
        <div style={{ opacity: numOp, fontFamily: DL_MONO, fontSize: 27, letterSpacing: 10, color: DL.red }}>DANSLAB · NO. 04</div>
        <div style={{ fontFamily: DL_SERIF, fontWeight: 500, fontSize: 148, color: DL.text, marginTop: 20 }}>
          The <span style={{ fontStyle: 'italic', color: DL.gold }}>Overseer</span>
        </div>
        ...
        <div style={{ opacity: tagOp, fontFamily: DL_SERIF, fontStyle: 'italic', fontSize: 40, color: DL.warm, marginTop: 30 }}>
          Four runaway machines. One founder. And the system that finally took command.
        </div>
      </AbsoluteFill>
    </AbsoluteFill>
  );
