...
ORDER = [
    ...
    ("OManaged", "s09_managed", 0.8), ("OSpine", "s10_spine", 0.8),
    ("OCall", "s10c_call", 0.8), ("OWarRoom", "s10d_warroom", 0.8), ("OSemeClaw", "s10e_semeclaw", 0.8),
    ("OSee", "s11_see", 0.8),
...
beats = {
 ...
 "OCall":[(3.0,"pop-reveal",.38),(5.7,"pop-reveal",.38),(12.0,"impact-soft",.44)],
 "OWarRoom":[(2.3,"pop-reveal",.34),(4.0,"pop-reveal",.32),(4.7,"pop-reveal",.32),(5.4,"pop-reveal",.32),(6.1,"pop-reveal",.32),(9.3,"scan-hum",.3),(14.3,"chime-magic",.48),(17.3,"ui-send",.36),(21.3,"impact-soft",.44)],
 "OSemeClaw":[(2.0,"impact-deep-soft",.48),(2.3,"chime-magic",.45),(5.0,"pop-reveal",.34),(5.7,"pop-reveal",.32),(6.5,"pop-reveal",.32),(10.0,"warm-shimmer",.4)],
